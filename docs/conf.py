...
html_logo = '_static/vsg.png'
html_favicon = '_static/vsg.ico'

# Output file base name for HTML help builder.
htmlhelp_basename = 'vsgDOC'
...
latex_documents = [
    (master_doc, 'VSG.tex', 'Video Shorts (and Blog) Generator',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'VSG', 'Video Shorts Generator Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'VSG', 'VSG Documentation',
     author, 'VSG', 'A quick overview of the VSG project.', 'Documentation',
     1),
]
